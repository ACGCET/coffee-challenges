...
export class EditLabelForm extends Component {
    state = {
        label_name: '',
    ...
    render () {
        ...
        const { label_name, description, input_color, default_color } = this.state
            ...
            <div>
                <div className="form">
                    ...
                    <div className="section2">
                        <button className="btn input-conatiner" onClick={this.props.toggleUpdateForm}>Cancel</button>
                        <button className="input-conatiner btn-primary" onClick={() => this.props.saveLabel(label_name, description, default_color)} disabled={!this.state.isButtonActive}>Save Changes</button>
                    </div>
                </div>
            </div>
        )
